...
import { IList, IInfo, IAdd, IEdit, IDel, IDetail } from './req';
import { IResInfo, IResDetail } from './res';
/** List*/
...
/** Detail*/
export async function apiDetail(postData: IDetail) {
  const config: AxiosRequestConfig = {
    url: '/hedging/detail',
    method: 'GET',
    params: omitBy(postData, (v: any) => v === ''),
  };
  return await axios.request<any, PageRes<IResDetail[]>>(config);
}
