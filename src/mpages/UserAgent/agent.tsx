        ...
        searchComponent={
          <Grid container xs={12} spacing={2}>
            ...
            <Grid xs={12} mt={0.5}>
              <Grid xs={12} mt={0.5}>
                <SelectOutline
                  placeholder={t('userAgent.currency')}
                  options={currencyList}
                  value={searchCfg.currency || ''}
                  setValue={(value: string) => {
                    setSearchCfg({ ...searchCfg, currency: value });
                  }}
                />
              </Grid>
            </Grid>
...
export default withPageHoc(MUserTabAgnet);
