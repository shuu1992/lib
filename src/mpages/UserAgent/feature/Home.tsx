...
import { Typography, Button, Stack, Tooltip, Divider, Link } from '@mui/material';
// ant-design
import {
  KeyOutlined,
  EditTwoTone,
...
import Add from '@pages/UserAgent/agent/feature/Add';
import Edit from '@pages/UserAgent/agent/feature/Edit';
import Credit from '@pages/UserAgent/agent/feature/Credit';
import Recycle from '@pages/UserAgent/agent/feature/Recycle';
import EditStatus from '@pages/UserAgent/agent/feature/EditStatus';
import AppInfo from '@pages/UserAgent/agent/feature/AppInfo';
    ...
    () => [
      {
        ...
        Cell: ({ row }: { row: any }) => {
          ...
          return (
            <Grid container spacing={0.5} style={{ minWidth: '75vw' }}>
              ...
              <Grid container xs={9.5}>
                ...
                <Grid xs={3} alignItems="center" justifyContent="flex-end">
                  <Button
                    size="small"
                    variant="outlined"
                ...
                <Grid xs={12}>
                  {t('sys.credit')} : {fcMoneyFormat(row.original.credit)}
                </Grid>
              </Grid>
            </Grid>
          );
      ...
      <PageTable
        ...
        searchComponent={
          <Grid container xs={12} spacing={2}>
            ...
            <Grid xs={12} mt={0.5}>
              <SelectOutline
                placeholder={t('userAgent.money_type')}
                options={moneyTypeList}
                value={searchCfg.money_type || ''}
                setValue={(value: string) => {
                  setSearchCfg({ ...searchCfg, money_type: value });
                }}
              />
            </Grid>
            <Grid xs={12} mt={0.5}>
