...
import Edit from '@pages/UserAgent/member/feature/Edit';
import Money from '@pages/UserAgent/member/feature/Money';
import ResetLose from '@pages/UserAgent/member/feature/ResetLose';
import Recycle from '@pages/UserAgent/member/feature/Recycle';
import EditStatus from '@pages/UserAgent/member/feature/EditStatus';
          ...
          return (
            <Grid container spacing={0.5} style={{ minWidth: '75vw' }}>
              ...
              <Grid container xs={9.5}>
                ...
                <Grid xs={6} textAlign="center" sx={{ textWrap: 'pretty' }}>
                  {t('userAgent.payoff')} &nbsp; {fcMoneyFormat(row.original.payoff)}
                </Grid>
              </Grid>
            </Grid>
          );
