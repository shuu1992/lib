...
import { apiList, apiInfo } from '@api/RechargeDepRec';
import { IList, IInfo, IAdd, IEdit, IDel } from '@api/RechargeDepRec/req';
import { IResInfo } from '@api/RechargeDepRec/res';
// material-ui
...
const RechargeDepRec = ({ pageHocProps = defaultPageHocProps }: WithPageHocProps) => {
  const {
    theme,
    menuState,
    globalState,
  ...
  const columns = useMemo(
    ...
    [t, theme, allPermission, editLoading],
  );
...
export default withPageHoc(RechargeDepRec);
