...
const Profile = () => {
  ...
  const [sysTimeValue, setSysTimeValue] = useState('');
  ...
  useEffect(() => {
    ...
    setSysTimeValue(dayjs(sysTime).format('YYYY-MM-DD HH:mm:ss'));
  }, [sysTime]);

  useEffect(() => {
    if (sysTime === null || sysTimeValue === '') return;
    setSysTimeValue(dayjs(sysTimeValue).add(1, 'second').format('YYYY-MM-DD HH:mm:ss'));
  }, [timeCount]);
                  ...
                  <CardContent sx={{ px: 2.5, pt: 3 }}>
                    ...
                    <Grid container justifyContent="space-between" alignItems="center">
                      <Grid>
                        <Stack direction="row" spacing={1.25} alignItems="center">
                          <Stack>
                            <Typography variant="h6">{sysTimeValue}</Typography>
                          </Stack>
                        </Stack>
                      </Grid>
                    </Grid>
