...
import { actionActiveID } from '@store/reducers/menu';
...
const NavGroup = ({
  ...
  const checkOpenForParent = (child: NavItemType[], id: string | number) => {
    child.forEach((ele: NavItemType) => {
      ...
      if (ele.url === pathname) {
        dispatch(actionActiveID(ele.id));
      }
    });
  };
  const checkSelectedOnload = (data: NavItemType) => {
    ...
    childrens.forEach((itemCheck: NavItemType) => {
      ...
      if (itemCheck.url === pathname) {
        dispatch(actionActiveID(currentItem.id!));
      }
    });
  };
          ...
          >
            ...
            <ListItemText
              ...
              primary={
                ...
                >
                  {currentItem.id === lastItemId ? <div>More Items</div> : currentItem.title}
                </Typography>
              }
            />
            {openMini ? (
